...
class PirateGame:
    ...
    def __init__(self) -> None:
        ...
        self.initAudio()
        self.loadMap()
        self.current_state = GameMenu(self.gamedata)  # the current state at start is set to game start?
        self.running = False
    ...
    def input_handler(self, event) -> None:
        ...
        self.current_state.input(event)  # sends the events to the current input handler of the current state
    ...
    def render(self) -> None:
        ...
        """
        self.current_state.render(self.screen)  # sends the screen to render to
        pygame.display.flip()
